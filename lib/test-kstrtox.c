...
#define for_each_test(i, test) for (i = 0; i < ARRAY_SIZE(test); i++)
...
#define TEST_FAIL(fn, type, fmt, test)                                             \
	{                                                                          \
		...
		{                                                                  \
			...
			if (rv >= 0) {                                             \
				WARN(1,                                            \
				     "str '%s', base %u, expected -E, got %d/" fmt \
				     "\n",                                         \
				     t->str, t->base, rv, tmp);                    \
				continue;                                          \
			}                                                          \
...
static void __init test_kstrtos64_fail(void)
{
	static DEFINE_TEST_FAIL(test_s64_fail) = {
		...
		{ "18446744073709551614", 10 }, { "18446744073709551615", 10 },
		{ "18446744073709551616", 10 }, { "18446744073709551617", 10 },
	};
...
static void __init test_kstrtos32_fail(void)
{
	static DEFINE_TEST_FAIL(test_s32_fail) = {
		{ "2147483648", 10 },		{ "2147483649", 10 },
		{ "4294967294", 10 },		{ "4294967295", 10 },
		{ "4294967296", 10 },		{ "4294967297", 10 },
		{ "9223372036854775806", 10 },	{ "9223372036854775807", 10 },
		{ "9223372036854775808", 10 },	{ "9223372036854775809", 10 },
		{ "18446744073709551614", 10 }, { "18446744073709551615", 10 },
		{ "18446744073709551616", 10 }, { "18446744073709551617", 10 },
	};
...
static void __init test_kstrtou16_ok(void)
{
	...
	static DEFINE_TEST_OK(struct test_u16, test_u16_ok) = {
		{ "0", 10, 0 },		{ "1", 10, 1 },
		{ "126", 10, 126 },	{ "127", 10, 127 },
		{ "128", 10, 128 },	{ "129", 10, 129 },
		{ "254", 10, 254 },	{ "255", 10, 255 },
		{ "256", 10, 256 },	{ "257", 10, 257 },
		{ "32766", 10, 32766 }, { "32767", 10, 32767 },
		{ "32768", 10, 32768 }, { "32769", 10, 32769 },
		{ "65534", 10, 65534 }, { "65535", 10, 65535 },
	};
...
static void __init test_kstrtos16_ok(void)
{
	...
	static DEFINE_TEST_OK(struct test_s16, test_s16_ok) = {
		{ "-130", 10, -130 },	{ "-129", 10, -129 },
		{ "-128", 10, -128 },	{ "-127", 10, -127 },
		{ "-1", 10, -1 },	{ "0", 10, 0 },
		{ "1", 10, 1 },		{ "126", 10, 126 },
		{ "127", 10, 127 },	{ "128", 10, 128 },
		{ "129", 10, 129 },	{ "254", 10, 254 },
		{ "255", 10, 255 },	{ "256", 10, 256 },
		{ "257", 10, 257 },	{ "32766", 10, 32766 },
		{ "32767", 10, 32767 },
	};
...
static void __init test_kstrtou8_ok(void)
{
	...
	static DEFINE_TEST_OK(struct test_u8, test_u8_ok) = {
		{ "0", 10, 0 },	    { "1", 10, 1 },	{ "126", 10, 126 },
		{ "127", 10, 127 }, { "128", 10, 128 }, { "129", 10, 129 },
		{ "254", 10, 254 }, { "255", 10, 255 },
	};
